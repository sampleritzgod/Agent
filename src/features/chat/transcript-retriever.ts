...
/**
 * Simple keyword-scored retriever over local transcript files. Placeholder for a
 * future vector search; kept behind {@link TranscriptRetriever} so it can be
...
export class LocalTranscriptRetriever implements TranscriptRetriever {
  ...
  async retrieve(input: RetrieveTranscriptChunksInput): Promise<RetrievedTranscriptChunk[]> {
