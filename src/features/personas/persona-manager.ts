...
/**
 * Loads and validates persona packs from `src/data/personas/<id>/persona.json`.
 * Also serves as the persona source for the chat feature (`getPersonaById`).
 */
export class PersonaManager {
  ...
  /** Alias used by the chat feature as its persona source. */
